...
const filterValues = (obj, func) => {
    return Object.fromEntries(Object.entries(obj).filter(([_, value]) => func(value)))
}
...
const reduceValues = (obj, func, value) => (value === undefined) ?  Object.values(obj).reduce(func) : Object.values(obj).concat(value).reduce(func)